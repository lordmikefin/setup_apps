...
def install():
    ...
    if util.is_os_windows():
        ...
        '''
        if not util.is_sudo_pass():
            logger.info('For installing any apps I need sudo password.')
            util.ask_root_pass()
    else:
